...
export default () => {
    ...
    const testimonials = [
        {
            imageSrc:
                'https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=formcepad=3.25&w=512&h=512&q=80',
            quote: 'It was just want we wanted to express our season!! Joni was helpful; she took a couple of our ideas and put them together for the perfect gift. Plus she had a very fast turn-around time.',
            customerName: 'Laurie',
